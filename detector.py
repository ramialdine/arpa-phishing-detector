"""
detector.py — Compatibility module exposing the public detector API.

This project is currently a flat module layout (no detector/ package folder),
so scripts import from this module directly:
